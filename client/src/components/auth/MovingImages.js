...
const MovingImages = () => {
    ...
    const [start, setStart] = useState("individualPhoto fade-in")
    const [end, setEnd] = useState("individualPhoto elementToFadeInAndOut")
    const [cssToggle, setCssToggle] = useState(true)
        ...
        <>
            <div className="emptyPhone" style={{ backgroundImage: "url('./emptyPhone.png')" }}>
                ...
                <div className="individualPhotoContainer">
                    ...
                    <img className="individualPhoto elementToFadeInAndOut" src={images}></img>
